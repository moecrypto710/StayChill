        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              {currentLanguage.code === 'ar' ? 'الكل' : 'All'}
            </Button>
            <Button
            ...
            >
              ...
              {currentLanguage.code === 'ar' ? 'غير مقروءة' : 'Unread'}
            </Button>
          </div>
        </div>
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="mt-4 text-muted-foreground">
                        {currentLanguage.code === 'ar' 
                          ? 'لا توجد رسائل في صندوق الوارد الخاص بك حتى الآن.' 
                          : 'You have no messages in your inbox yet.'}
                      </p>
                      <Button 
                        className="mt-4" 
                        variant="outline"
                        ...
                        {filteredRooms.map((room) => (
                          <div 
                            ...
                            className={`p-4 flex items-center gap-4 cursor-pointer hover:bg-accent/50 transition-colors ${
                              room.unreadCount > 0 ? 'bg-accent/20' : ''
                            }`}
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between">
                                <h3 className="font-medium truncate">
                                  {room.property?.title || room.title}
                                </h3>
