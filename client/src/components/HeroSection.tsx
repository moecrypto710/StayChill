...
export default function HeroSection() {
  ...
  return (
    <section className="py-4 md:py-8 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-3 md:px-4">
        <div className="max-w-4xl mx-auto space-y-3 md:space-y-4 animate-in fade-in slide-in-from-bottom-5 duration-700">
          {/* Hero text */}
